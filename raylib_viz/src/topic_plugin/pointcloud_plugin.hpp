...
public:
  ...
  void onPointCloud(const sensor_msgs::msg::PointCloud2::SharedPtr msg) { buffer_.addData(msg); }

  void visualize() override
  {
    const auto message =
      buffer_.getDataByTimestamp(std::chrono::system_clock::time_point(std::chrono::seconds(0)));
    ...
    std::cout << "PointCloudPlugin::visualize()" << std::endl;
  }
